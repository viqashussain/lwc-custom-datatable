...
export default class LookupLwc extends LightningElement {
    ...
    @track inputClass = 'background-inherit';
    @track sldsFormElement = 'slds-combobox__form-element slds-input-has-icon slds-input-has-icon_right';
    ...
    @wire(lookUp, { searchTerm: '$searchTerm', objectName: '$objName', filters: '$filters', additionalSearchField: '$additionalSearchField', fields: '$displayFields' })
    ...
    handleClick() {
        this.searchTerm = '';
        this.inputClass = 'background-inherit slds-has-focus';
